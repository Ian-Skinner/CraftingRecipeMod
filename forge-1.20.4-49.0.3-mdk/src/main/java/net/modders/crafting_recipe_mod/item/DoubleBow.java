...
public class DoubleBow extends BowItem{
    ...
    @Override
    public void releaseUsing(ItemStack arrowStack, Level world, LivingEntity player, int something){
        this.Shoot(arrowStack, world, player, something);
        this.Shoot(arrowStack, world, player, something);
    }
    
    public void Shoot(ItemStack p_40667_, Level p_40668_, LivingEntity p_40669_, int p_40670_) {
