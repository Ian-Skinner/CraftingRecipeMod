...
import net.modders.crafting_recipe_mod.entities.SpikeySnowball;

public class SpikeySnowballitem extends Item {

    public SpikeySnowballitem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
      ...
      if (!p_43142_.isClientSide) {
         SpikeySnowball snowball = new SpikeySnowball(p_43142_, p_43143_);
